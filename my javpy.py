...
joke_list = ['joke2.mp3 ', 'joke1.mp3', 'engjoke3.mp3', 'joke1.mp3', 'joke2.mp3', 'joke3.mp3', 'joke4.mp3']
       ...
       # elif ' game' in voice_note:
        #    static_speech('let me play snake game for you')
         #   snake.snake()
            ...
            pic.save('C:/Users/ASUS/Desktop/Screenshot.png')

        # god exist
        elif 'god exist' in voice_note or 'god is exist' in voice_note:
            static_speech('my boss david, who created me he is exist ')
